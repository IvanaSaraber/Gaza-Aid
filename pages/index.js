...
export default function Home() {
  ...
  return (
    <div style={{ padding: '2rem', backgroundColor: '#f7f9fc', minHeight: '100vh' }}>
      <h1 style={{ textAlign: 'center', marginBottom: '2rem', fontSize: '2rem', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '1rem' }}>
        <button 
          ...
          style={{
            backgroundColor: selectedFilter === 'bijna_compleet' ? '#6B8E23' : '#ccc', 
            color: 'white', padding: '0.5rem 1rem', borderRadius: '5px', margin: '0 0.5rem'
          }}
        >
          Bijna compleet
        </button>
        <button 
          ...
          style={{
            backgroundColor: selectedFilter === 'nieuw' ? '#6B8E23' : '#ccc', 
            color: 'white', padding: '0.5rem 1rem', borderRadius: '5px', margin: '0 0.5rem'
          }}
        >
          Nieuwe campagnes
        ...
        <button 
          ...
          style={{
            backgroundColor: selectedFilter === 'lang_niet_doneren' ? '#6B8E23' : '#ccc', 
            color: 'white', padding: '0.5rem 1rem', borderRadius: '5px', margin: '0 0.5rem'
          }}
        >
          Lang niet gedoneerd
        ...
        <button 
          ...
          style={{
            backgroundColor: '#ff6f61', color: 'white', padding: '0.5rem 1rem', borderRadius: '5px', margin: '0 0.5rem'
          }}
        >
          Reset filters
        </button>
          ...
          >
            ...
            <div style={{ padding: '1rem', flexGrow: 1 }}>
              ...
              <p style={{ marginBottom: '1rem', color: '#666' }}>
                {`€${c.fields?.["Opgehaald bedrag"]} van €${c.fields?.["Doelbedrag"]}`}
              </p>
            ...
            <div style={{ padding: '1rem' }}>
              <a 
                ...
                onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#4b7c20'}
